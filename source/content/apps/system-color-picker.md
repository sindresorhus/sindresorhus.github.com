...
- [2.0.3](https://github.com/sindresorhus/sindresorhus.github.com/releases/download/v1.0.0/Color.Picker.2.0.3.-.macOS.14.zip) for macOS 14+
- [1.15.0](https://github.com/user-attachments/files/20202232/Color.Picker.1.15.0.-.macOS.13.zip) for macOS 13+
- [1.12.1](https://github.com/user-attachments/files/20202231/Color.Picker.1.12.1.-.macOS.12.zip) for macOS 12+
- [1.9.6](https://github.com/user-attachments/files/20202230/Color.Picker.1.9.6.-.macOS.11.zip) for macOS 11+

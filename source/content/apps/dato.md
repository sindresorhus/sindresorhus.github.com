...
olderMacOSVersions:
  ...
  - '14'
feedbackNote: |
  [Missing menu bar item](If a menu bar icon is missing, see <a href="https://sindresorhus.com/apps/faq#app-not-showing-in-menu-bar">this</a>.)
...
Try the fully functional trial [here](https://www.dropbox.com/scl/fi/11dbfxi97yaul8xn4l27n/Dato-5.6.5-trial-1759248287.zip?rlkey=q2mxukzngnqh65rma8p1eiqja&raw=1). The only limitation is a reminder to buy the app every 12 hours, and no automatic updates. All data and settings carry over if you buy it on the App Store.

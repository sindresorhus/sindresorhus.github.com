...
Try the fully functional trial [here](https://www.dropbox.com/scl/fi/794x85vaoewdpk3td1mom/Supercharge-1.22.0-trial-1760772049.zip?rlkey=v3e3u83iuvm8kko3oedcfsemb&raw=1). The only limitation is a reminder to buy the app every 12 hours, and no automatic updates. All data and settings carry over if you buy it.

...
Won't quit or hide apps when your camera or microphone is active, screen is being captured, or the app is in use. Menu bar-only apps (like background utilities) won't be auto-quit since they never become active or inactive.

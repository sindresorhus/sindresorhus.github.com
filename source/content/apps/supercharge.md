...
Try the fully functional trial [here](https://www.dropbox.com/scl/fi/va0sxt7e32qpdr2xrbjp9/Supercharge-1.12.0-trial-1739705569.zip?rlkey=6eigubycli4j75owjzwmmzagi&raw=1). The only limitation is a reminder to buy the app every 12 hours, and no automatic updates. All data and settings carry over if you buy it.
...
This usually happens when an app [blocks keyboard input reading](#secure-input-problem).

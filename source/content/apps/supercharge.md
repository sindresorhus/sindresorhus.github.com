...
<sup>Requires macOS 15.3 or later</sup>
...
- Prevent Dock from showing when moving mouse to screen edge
	<span class="list-description">Useful if you want to hide the Dock entirely or only show it with a keyboard shortcut.</span>
...
[Screenshot](https://github.com/user-attachments/assets/67290c47-4d78-490f-b0b8-f263ebc1022d)
...
[Screenshot](https://github.com/user-attachments/assets/d929e3fe-6605-46f6-a99f-6f0f3486a88e)
...
Try the fully functional trial [here](https://www.dropbox.com/scl/fi/f61m54nnv9lyfpae0191o/Supercharge-1.17.1-trial-1747026455.zip?rlkey=xi2roq0mwrjne8y0m62hsl12x&raw=1). The only limitation is a reminder to buy the app every 12 hours, and no automatic updates. All data and settings carry over if you buy it.
